...
for func_name_debug in functions_name_array:
    ...
    for func_name_release in functions_name_array:
        ...
        # if func_name_debug != None and func_name_release != None:

        debug_grades = debug_library_grades[func_name_debug]
    ...
    index += 1
    final_grades[func_name_debug] = debug_grades

    json_append(base + 'final_grades_n_by_n.txt', final_grades)
...
json_append(base + 'final_grades_n_by_n.txt', {'dddd'})